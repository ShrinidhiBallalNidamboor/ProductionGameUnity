...
public class DialogManager : MonoBehaviour
{
    ...
    //File control
    private string filemessenger = "../Database/Messenger/Manager5.txt";
    private string filewarehouse = "../Database/Warehouse/Warehouse5.txt";
    private string filedemand = "../Database/Demand.txt";
    ...
    private void Start() {
        ...
        RunPython("python3", "../Managers/Manager.py", 6, "", 0);
        using (StreamReader reader = new StreamReader(filedemand))
        {
            string line;
    ...
    {
        Text text = _order.transform.GetChild(0).GetChild(1).transform.GetComponent<Text>();
        RunPython("python3", "../Managers/Manager.py", 7, text.text, 1);
    }
    ...
    public void ShowMenu(int type, Action onNpcDialogFinish = null)
    {
        ...
        using (StreamReader reader = new StreamReader(filewarehouse))
        {
            ...
            string bike = lastline.Split('-')[1].Split(',')[0];
            CountUpdate(_menu, 0, bike);
        }
        _state = type;
